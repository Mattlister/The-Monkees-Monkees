...
## Please view the Website in GitHub pages
...
I’ve used BootstrapCDN as the main backbone language allowing functionality and responsive design which sits in an HTML shell with added
...
body of the site. BootstrapCDN has been used for the layout to add grids to the pages so it displays on screen with responsive fluid design.
